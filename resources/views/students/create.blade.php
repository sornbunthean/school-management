...
<div class="card-body">
      ...
      @endif
      <form action="{{ route('student.store') }}" class="new-added-form" data-select2-id="18" method="POST" enctype="multipart/form-data">
            {{ csrf_field() }}
            <div class="row">
                  <div class="col-md-8 col-8">
                        <div class="row">
                              <div class="col-md-6 col-lg-6 col-6 form-group">
                                    ...
                                    <input type="text" class="form-control" name="first_name" autofocus required value="{{ old('first_name') }}">
                              </div>
                              ...
                              <div class="col-md-6 col-lg-6 col-6 form-group">
                                    ...
                                    <input type="text" class="form-control" name="father_name" value="{{ old('fahter_name') }}">
                              </div>
                              <div class="col-md-6 col-lg-6 col-6 form-group">
                              ...
                              <div class="col-md-6 col-lg-6 col-6 form-group">
                                ...
                                <div class="col-md-6 col-lg-6 col-6 form-group">
                                    ...
                                    <input type="text" placeholder="dd/mm/yyyy" class="form-control air-datepicker"
                                        data-position='bottom right' name="dob" id="date">
