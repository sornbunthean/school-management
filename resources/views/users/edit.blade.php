...
<div class="card-body">
      ...
      <form action="{{ route('user.update', $user->id) }}" class="new-added-form" data-select2-id="18" enctype="multipart/form-data">
            {{ csrf_field() }}
            @method('PATCH') 
            <div class="row">
                  <div class="col-md-8 col-8">
                        <div class="row">
                              <div class="col-md-6 col-lg-6 col-6 form-group">
                                    ...
                                    <input type="text" class="form-control" name="name" autofocus required value="{{ $user->name }}">
                              </div>
                  ...
                  <div class="col-md-4 col-4">
                        <div class="col-lg-6 col-12 form-group mg-t-30">
                              ...
                              <p style="margin-top:10px;">
                                    <img src="{{ $user->photo }}" alt="" id="img" width="200" class="img-thumbnail">
                              </p>
